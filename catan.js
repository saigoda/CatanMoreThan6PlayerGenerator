...
var crazyExtension = new MapDefinition();
crazyExtension.resourceDict = {
		"desert": 3,
		"wood": 10,
		"clay": 8,
		"wool": 10,
...
crazyExtension.coordinatesArray = [
		[-12,0],
		[-10,1],[-10,-1],
		[-8,2],[-8,0],[-8,-2],
		[-6,3],[-6,1],[-6,-1],[-6,-3],
...
var evenCrazierExtension = new MapDefinition();
evenCrazierExtension.resourceDict = {
		"desert": 5,
		"wood": 12,
		"clay": 10,
		"wool": 12,
...
evenCrazierExtension.numberDict = {
		2: 4,
		3: 6,
		4: 6,
		5: 6,
...
evenCrazierExtension.coordinatesArray = [
		[-8,4],[-8,2],[-8,0],[-8,-2],[-8,-4],
		[-6,5],[-6,3],[-6,1],[-6,-1],[-6,-3],[-6,-5],
		[-4,6],[-4,4],[-4,2],[-4,0],[-4,-2],[-4,-4],[-4,-6],
...
function generate() {
	...
	switch($("input:radio['name=game-type']:checked").val()) {
		case "expanded":
			...
			break;
		case "crazyExpansion":
			mapDef = crazyExtension;
			break;
		case "evenCrazyExpansion":
			mapDef = evenCrazierExtension;
			break;
		default:
			mapDef = normalMap;
	}
